...
const router = express.Router();    // Crea un nuevo enrutador de express// o sea un Manejador de rutas de express
...
// Nuevo evento
router.post("/evento/nuevo", verifyToken, (req, res) => { // Ruta POST para crear un nuevo evento
